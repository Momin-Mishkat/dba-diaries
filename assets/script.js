  ...
  const hinglish = {
    ...
    "t-hero-tag": "Oracle, OCI, aur PostgreSQL administration par practical, production-tested insights — performance tuning, backup aur recovery, high availability, aur cloud architecture.",
    "t-about": "Mai Momin Mishkat hu, ek Oracle Database Administrator jise Oracle Core, Oracle RAC, aur Oracle Cloud Infrastructure (OCI) Database services mein hands-on expertise hai. Mera kaam production databases ko reliable rakhne ke around centered hai — performance tuning, backup aur recovery, high availability architecture, aur wo operational discipline jo bade incidents banne se pehle hi problems pakad leti hai. Yahan mai wahi document karta hu jo main actually production mein work karta hu — real scenarios, real commands, real trade-offs — na ki certification-guide wali theory. Regularly naye posts, jisme Oracle, OCI, aur increasingly PostgreSQL cover hote hain.",
